...
class ApiRouter {
  ...
  init() {
    ...
    this.router.post('/libraries/:id/complete-metadata', LibraryController.middleware.bind(this), LibraryController.completeMetadata.bind(this))
    ...
    this.router.get('/ai-book-match/settings', MiscController.getAiBookMatchSettings.bind(this))
    this.router.get('/metadata-proxy/settings', MiscController.getMetadataProxySettings.bind(this))
    ...
    this.router.post('/chinese-search/run', MiscController.runChineseSearch.bind(this))
    this.router.post('/chinese-search/stop', MiscController.stopChineseSearch.bind(this))
