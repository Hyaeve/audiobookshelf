...
class AudioFile {
  ...
  setDataFromStrm(libraryFile) {
    this.ino = libraryFile.ino || null
    this.metadata = libraryFile.metadata instanceof FileMetadata ? libraryFile.metadata.clone() : new FileMetadata(libraryFile.metadata)
